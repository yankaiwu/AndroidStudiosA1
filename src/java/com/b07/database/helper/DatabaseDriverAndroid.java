...
public class DatabaseDriverAndroid extends SQLiteOpenHelper {
  ...
  protected int getUserIdByLogin(String login) throws UserNotFoundException {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    Cursor cursor = sqLiteDatabase.rawQuery("SELECT USERID FROM USERLOGIN WHERE LOGIN = ?",
            new String[]{login});
  ...
  protected Cursor getAllAccounts() {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    return sqLiteDatabase.rawQuery("SELECT * FROM ACCOUNT",
            null);
  }
  ...
  protected Cursor getUserLoginList() {
    SQLiteDatabase sqLiteDatabase = getReadableDatabase();
    return sqLiteDatabase.rawQuery("SELECT * FROM USERLOGIN",
            null);
  }
